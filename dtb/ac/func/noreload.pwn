...
{
	static previous_weaponid[MAX_PLAYERS char], previous_ammo[MAX_PLAYERS];

	if (weaponid == previous_weaponid { playerid })
	{
		new slot = GetWeaponSlot(weaponid), slot_weaponid, slot_ammo;

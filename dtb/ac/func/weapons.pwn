ac_CheckPlayerWeapons(playerid)
{
	for (new slot; slot < 13; slot++)
	{
		...
		{
			new client_weaponid, client_ammo, ac_weaponid, ac_ammo;
			...
			if (g_acWeaponSynced[playerid][slot] && (client_weaponid != ac_weaponid || client_ammo > ac_ammo)
				&& client_weaponid != 0 && client_weaponid != 46)
			{

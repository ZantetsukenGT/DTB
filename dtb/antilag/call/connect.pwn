...
hook OnPlayerConnect(playerid)
{
	...
	g_AntilagBoxTD[playerid]	   = CreatePlayerTextDraw(playerid, 569.0, 1.0, "_");
	...
	g_PingTD[playerid] = CreatePlayerTextDraw(playerid, 501.0, 2.0, "Ping:");
	...
	g_FramerateTD[playerid] = CreatePlayerTextDraw(playerid, 553.0, 2.0, "FPS:");
	...
	g_PacketlossTD[playerid] = CreatePlayerTextDraw(playerid, 638.0, 2.0, "Packetloss:");

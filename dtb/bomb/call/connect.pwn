...
{
	g_BombProgressBackTD[playerid] = CreatePlayerTextDraw(playerid, 320.0, 403.0, "_");
	...
	g_BombProgressMaxTD[playerid] = CreatePlayerTextDraw(playerid, 261.0, 405.0, "_");
	...
	g_BombProgressValueTD[playerid] = CreatePlayerTextDraw(playerid, 261.0, 405.0, "_");
	...
	g_BombTextTD[playerid] = CreatePlayerTextDraw(playerid, 320.0, 401.0, "Planting Bomb");

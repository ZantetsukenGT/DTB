...
hook OnSecondPassed()
{
	if (g_GameState == STATE_STARTED)
	{
		...
		{
			new mapid = g_MapID,
				bombsite = g_BombPlantSite, Float: x,
				Float: y,
				Float: z;
			...
			else
			{
				switch (g_GameTime)
				{
					case 5: PlaySoundForAll(7416, x, y, z);
					case 3: PlaySoundForAll(7417, x, y, z);
					case 2: PlaySoundForAll(7418, x, y, z);
					case 1: PlaySoundForAll(7419, x, y, z);
				}
			}
		}

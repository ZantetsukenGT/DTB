CreatePlayerSession(playerid)
{
	...
	mysql_format(
		...
		g_PlayerAccountID[playerid], g_PlayerName[playerid], g_PlayerIP[playerid], g_PlayerGPCI[playerid],
		g_PlayerCountry[playerid], g_PlayerCity[playerid], g_PlayerISP[playerid], GetPlayerJoinTime(playerid),
		g_IsPlayerLoggedIn { playerid }, g_PlayerLoginAttempts { playerid } > 0);

...
{
	g_PlayerLevelBoxTD[playerid] = CreatePlayerTextDraw(playerid, 498.0, 79.0, "_");
	...
	g_PlayerXPMaxTD[playerid] = CreatePlayerTextDraw(playerid, 500.0, 92.0, "_");
	...
	g_PlayerXPProgressTD[playerid] = CreatePlayerTextDraw(playerid, 500.0, 92.0, "_");
	...
	g_PlayerLevelTextTD[playerid] = CreatePlayerTextDraw(playerid, 499.0, 77.0, "Level");
	...
	g_PlayerXPTextTD[playerid] = CreatePlayerTextDraw(playerid, 553.0, 90.0, "XP");

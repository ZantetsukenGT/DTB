SetPlayerCameraAtBombsite(playerid, bombsiteid)
{
	...
	InterpolateCameraPos(playerid, from_x, from_y, from_z, to_x, to_y, to_z, 3 * 1000, CAMERA_MOVE);

	// Move camera look at
	InterpolateCameraLookAt(playerid, bomb_x, bomb_y, bomb_z, bomb_x, bomb_y, bomb_z, 3 * 1000, CAMERA_MOVE);
}

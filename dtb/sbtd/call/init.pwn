...
hook OnGameModeInit()
{
	for (new teamid; teamid < 2; teamid++)
	{
		switch (teamid)
		{
			case TEAM_ATTACK: g_ScoreboardBoxTD[teamid] = TextDrawCreate(320.0, 130.0, "_");
			case TEAM_DEFEND: g_ScoreboardBoxTD[teamid] = TextDrawCreate(320.0, 253.0, "_");
		}
		...
		switch (teamid)
		{
			case TEAM_ATTACK: g_ScoreboardRowTD[teamid] = TextDrawCreate(320.0, 119.0, "_");
			case TEAM_DEFEND: g_ScoreboardRowTD[teamid] = TextDrawCreate(320.0, 242.0, "_");
		}
		...
		switch (teamid)
		{
			case 0: g_ScoreboardTeamTD[teamid] = TextDrawCreate(170.0, 118.0, g_TeamNames[teamid]);
			case 1: g_ScoreboardTeamTD[teamid] = TextDrawCreate(170.0, 240.0, g_TeamNames[teamid]);
		}
		...
		foreach (new slot : Player)
		{
			switch (teamid)
			{
				case TEAM_ATTACK:
				{
					g_ScoreboardPlayerTD[teamid][slot]	 = TextDrawCreate(170.0, 128.0 + (slot * 10.0), "Player");
					g_ScoreboardBombTD[teamid][slot]	 = TextDrawCreate(287.0, 128.0 + (slot * 10.0), "Bomb Planter");
					g_ScoreboardHealthTD[teamid][slot]	 = TextDrawCreate(345.0, 128.0 + (slot * 10.0), "Health");
					g_ScoreboardScoreTD[teamid][slot]	 = TextDrawCreate(377.0, 128.0 + (slot * 10.0), "Score");
					g_ScoreboardDamageTD[teamid][slot]	 = TextDrawCreate(400.0, 128.0 + (slot * 10.0), "Damage");
					g_ScoreboardAccuracyTD[teamid][slot] = TextDrawCreate(436.0, 128.0 + (slot * 10.0), "Accuracy");
				}
				case TEAM_DEFEND:
				{
					g_ScoreboardPlayerTD[teamid][slot]	 = TextDrawCreate(170.0, 251.0 + (slot * 10.0), "Player");
					g_ScoreboardBombTD[teamid][slot]	 = TextDrawCreate(287.0, 251.0 + (slot * 10.0), "Bomb Defuser");
					g_ScoreboardHealthTD[teamid][slot]	 = TextDrawCreate(345.0, 251.0 + (slot * 10.0), "Health");
					g_ScoreboardScoreTD[teamid][slot]	 = TextDrawCreate(377.0, 251.0 + (slot * 10.0), "Score");
					g_ScoreboardDamageTD[teamid][slot]	 = TextDrawCreate(400.0, 251.0 + (slot * 10.0), "Damage");
					g_ScoreboardAccuracyTD[teamid][slot] = TextDrawCreate(436.0, 251.0 + (slot * 10.0), "Accuracy");
				}
			}
	...
	for (new column; column < 4; column++)
	{
		switch (column)
		{
			case 0: g_ScoreboardColumnTD[column] = TextDrawCreate(345.0, 118.0, "Health");
			case 1: g_ScoreboardColumnTD[column] = TextDrawCreate(377.0, 118.0, "Score");
			case 2: g_ScoreboardColumnTD[column] = TextDrawCreate(400.0, 118.0, "Damage");
			case 3: g_ScoreboardColumnTD[column] = TextDrawCreate(436.0, 118.0, "Accuracy");
		}

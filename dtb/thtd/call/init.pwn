...
hook OnGameModeInit()
{
	...
	{
		g_TeamMaxHealthTD[teamid] = TextDrawCreate(321.0, 437.0, "_");
		...
		g_TeamCurrentHealthTD[teamid] = TextDrawCreate(321.0, 437.0, "_");
		...
		switch (teamid)
		{
			case TEAM_ATTACK:
			{
				g_TeamTextHealthTD[teamid] = TextDrawCreate(318.0, 435.0, "0");
				TextDrawAlignment(g_TeamTextHealthTD[teamid], 3);
			}
			case TEAM_DEFEND:
			{
				g_TeamTextHealthTD[teamid] = TextDrawCreate(322.0, 435.0, "0");

...
{
	g_WeaponMenuBoxTD[playerid] = CreatePlayerTextDraw(playerid, 320.0, 107.0, "_");
	...
	g_WeaponMenuTitleTD[playerid] = CreatePlayerTextDraw(playerid, 196.0, 93.0, "Title");
	...
	g_WeaponMenuBackTD[playerid] = CreatePlayerTextDraw(playerid, 395.0, 108.0, "Press here to go back");

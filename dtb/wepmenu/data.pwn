...
new const g_MenuWeapons[]
	= { WEAPON_COLT45, WEAPON_SILENCED, WEAPON_DEAGLE, WEAPON_SHOTGUN, WEAPON_SAWEDOFF, WEAPON_SHOTGSPA, WEAPON_AK47,
		WEAPON_M4,	   WEAPON_RIFLE,	WEAPON_SNIPER, WEAPON_UZI,	   WEAPON_TEC9,		WEAPON_MP5 };
